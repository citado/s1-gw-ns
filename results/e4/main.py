...
axs[0].set(ylabel="Delivery Ratio (%)", xlabel="Packet Rate (pps)")
...
axs[1].set(ylabel="Average Delay (s)", xlabel="Packet Rate (pps)")
...
axs[2].set(ylabel="P90 Delay (s)", xlabel="Packet Rate (pps)")
