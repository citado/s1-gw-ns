...
for number_of_gateways in \
        ["g1", "g2", "g3", "g5", "g7", "g8", "g10", "g15", "g20"]:
...
ax.set(ylabel="Delivery Ratio (%)", xlabel="Number of Gateways")
...
ax.set(ylabel="Average Delay (s)", xlabel="Number of Gateways")
...
ax.set(ylabel="P90 Delay (s)", xlabel="Number of Gateways")
